...
angular
    ...
    .run(function ($rootScope, $window) {
        ...
        $rootScope.mLatitude = 31.630745;
        $rootScope.mLongitude = -7.994816;
        ...
        $rootScope.loadEndpoints = function () {
           ...
           // $rootScope.api = gapi.client.guideAppApi; //TODO  revoir
            $rootScope.$apply();
...
angular.module('guideAppApp').service('City', function($resource)
{
    var restAPIUrl = 'http://127.0.0.1:8000/api';
    return $resource(restAPIUrl + '/cities/:id', { id: '@id' } ,{'query': { method: 'GET' }});
});


angular.module('guideAppApp').service('Local', function($resource)
{
    var restAPIUrl = 'http://127.0.0.1:8000/api';
    return $resource(restAPIUrl + '/locals/:id', { id: '@id' } ,{'query': { method: 'GET' }});
});
...
/*function initAuth() {
    gapi.load('auth2', function () {
        var auth2 = gapi.auth2.getAuthInstance({
          client_id: '254290475198-3elue6lja9c5pe9ur6as83r0or5bavj8.apps.googleusercontent.com',
